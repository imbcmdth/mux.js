...
AudioSegmentStream = function(track) {
  ...
  this.prefixWithSilence_ = function (track, frames) {
    ...
    if (audioAppendStartTs &&
      ...
      audioGapCount = Math.floor(audioGap / frameDuration);
      // ensure gap is a whole number of frames
      audioGapDuration = audioGapCount * frameDuration;
    }

    if (audioGapCount > 0 &&
        // smaller than a half second
        audioGapDuration < ONE_SECOND_IN_TS / 2 &&
        frames.length) {
      ...
      track.baseMediaDecodeTime -=
        Math.floor(clock.videoTsToAudioTs(audioGapDuration, track.samplerate));
    }
  };
