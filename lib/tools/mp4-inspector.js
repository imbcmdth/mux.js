...
var ppsCodec = require('../nal-unit-codec/pic-parameter-set');
var spsCodec = require('../nal-unit-codec/seq-parameter-set');
...
var
  ...
  nalParse = function(avcStream) {
    ...
    for (i = 0; i + 4 < avcStream.length; i += length) {
      ...
      switch (nalUnitType) {
      case 0x01:
        var nalObject = sliceLayerWithoutPartitioningCodec.decode(nalData, lastOptions);
      ...
      case 0x05:
        ...
        var nalObject = sliceLayerWithoutPartitioningCodec.decode(nalData, newOptions);
      ...
      case 0x08:
        ...
        break;
      case 0x09:
        var nalObject = audCodec.decode(nalData);
...
domifyMp4 = function (inspectedMp4) {
  var topLevelObject = {
    type: 'mp4',
    boxes: inspectedMp4,
...
domifyBox = function (box, parentNode, depth) {
...
makeProperty = function (name, value, parentNode) {
