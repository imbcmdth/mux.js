...
let debug = combinators.debug;
let verify = combinators.verify;

let when = conditionals.when;
let each = conditionals.each;
let inArray = conditionals.inArray;
let equals = conditionals.equals;
let some = conditionals.some;
let every = conditionals.every;
let not = conditionals.not;
let whenMoreData = conditionals.whenMoreData;

let ue = dataTypes.ue;
let u = dataTypes.u;
let se = dataTypes.se;
let val = dataTypes.val;
let v = null;

let ppsCodec = start('pic_parameter_set',
  list([
